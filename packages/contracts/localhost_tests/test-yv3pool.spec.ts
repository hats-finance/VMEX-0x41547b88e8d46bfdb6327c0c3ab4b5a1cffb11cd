...
var triCryptoDepositAbi = [
    ...
    "function calc_token_amount(uint256[3] _amounts,bool deposit) external view"
        ...
        const yearnVault = new DRE.ethers.Contract("0x84E13785B5a27879921D6F685f041421C7F482dA",yvAbi)
          ...
          it("get LP and yv tokens", async () => {
            ...
            expect(
              (await yearnVault.connect(signer).balanceOf(signer.address)).toString()
